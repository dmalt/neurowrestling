...
conn = rpyc.classic.connect('169.254.23.59') # host name or IP address of the EV3
...
if __name__ == '__main__':
    ...
    # ----------------------------------------------------------- #
    if not(stream_pl1 and stream_pl2):
        raise CustomException('STREAM CONNECTION ERROR')
